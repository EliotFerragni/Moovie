...
public partial class SettingsView : UserControl
{
    ...
    /// <summary>
    /// Raised when the user is done with the settings, true if they saved. The view has no idea
    /// whether it sits in a window or in an overlay, so dismissing it is the host's business.
    /// </summary>
